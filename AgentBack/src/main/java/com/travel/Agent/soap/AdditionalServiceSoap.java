...
public class AdditionalServiceSoap {
    ...
    private static GetDistinctServicesResponse distinctService;
    ...
    private static void callSoapWebService(String soapEndpointUrl, String soapAction) {
        try {
            ...
            JAXBContext jaxbContext = JAXBContext.newInstance(GetDistinctServicesResponse.class);
